      ...
      <div class="paySection" style="margin-top:0">
        ...
        <div class="payContent">
          ...
          <div class="contentLine">
            ...
            <div class="reminding">注：全球个人会员付费期间可与国内外会员/非会员免费通信</div>
          </div>
        </div>
      </div>
...
export default {
  data(){
    return {
      activeIndex: '1',
      vipData: [
        { money: 19.99, amount: 1, text: '1个月'},
        { money: 14.99, amount: 6, text: '6个月'},
        { money: 9.99, amount: 12, text: '1年'}
      ],
      payWayData: [
        { text: "支付宝", value: "zfb" },
        { text: "微信支付", value: "wx" },
